    ...
    <section class="introSec" id="home">
        ...
        <div class="introCon">
            <div class="introText">
                <h2>Hello,</h2>
                <h1>I'm Nicole</h1>
                <p> < p> I’m a Jr. Web developer, I’m passionate about learning, building intuitive user experiences, and contributing to meaningful projects. < /p></p>
                <a  class="dowloadBtn" href="{{ asset('assets/nicoleTumpag_dev.pdf') }}" download>Download resume</a>
